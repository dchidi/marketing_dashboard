...
import styles from "./CancelledPolicy.module.css";
import { Row } from "../../layouts/row_col/RowCol";
import Card from "../../layouts/card/Card";
import Modal from "../../layouts/modal/Modal";
import { useCancelledPolicy } from "./useCancelledPolicy";
...
const CancelledPolicy: React.FC = () => {
  ...
  const { quoteData, columns } = useCancelledPolicy();
