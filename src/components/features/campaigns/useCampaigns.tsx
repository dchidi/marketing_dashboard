...
import type { quoteGraphProps, QuoteProps, useQuoteProps } from "./types";

export const useCampaigns = (): useQuoteProps => {
  ...
  // Fetch graph data
  const quoteData: quoteGraphProps[] = [
    { id: 1, height: 130, value: "16.2k", text: "Cat" },
    { id: 2, height: 200, value: "32.1k", text: "Dog" },
    { id: 3, height: 20, value: "600", text: "Horse" },
    { id: 4, height: 45, value: "2.1k", text: "Exotic" },
  ];
  // Fetch total. This can come from same api call for graph data
  const totalQuotes = "132.5k";

  return { quoteTableData, columns, quoteData, totalQuotes };
};
