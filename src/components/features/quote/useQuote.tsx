...
export const useQuote = (): useQuoteProps => {
  ...
  const quoteData: quoteGraphProps[] = [
    { id: 1, height: 180, value: "16.2k", text: "Cat" },
    { id: 2, height: 250, value: "32.1k", text: "Dog" },
    { id: 3, height: 30, value: "600", text: "Horse" },
    { id: 4, height: 75, value: "2.1k", text: "Exotic" },
  ];
